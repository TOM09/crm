			...
			<div v-if="dialogValChildTitle2 === '提交'">
				<el-form ref='r_data' label-position="right" label-width="120px" :model="r_data">
					...
					<el-form-item label="附件 :">
						<!-- <upload22 @fileStatus="fileStatus"  @fileTrue="fileTrue" :success="success"  :rdataFile = 'rdataFile' v-model="r_data.file" ></upload22> -->
...
<!-- :prop="'excutor_detail.' + index + '.excutor_leading'"  -->
			...
			<div v-else-if="dialogValChildTitle2 === '删除'">
