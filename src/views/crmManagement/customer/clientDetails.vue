...
<template>
  <div class="clientDetails">
    ...
    <el-dialog title="联系人添加" :visible.sync="dialogTable" :modal="false" width="30%">
    ...
    <el-dialog title="客户信息修改" :visible.sync="dialogTableVisible" :modal="false" width="600px">
      <el-form ref="form" :model="form" label-position="right" label-width="100px">
        ...
        <el-form-item label="咨询日期" prop="ask_time" class="s_client_sel_div">
          <el-date-picker
        ...
        <el-form-item label="备注：">
          <el-input v-model="form.brief" type="textarea" autosize placeholder="请输入" class="s_client_sel_div"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer">
    ...
    <el-dialog title="编辑共同负责人" :visible.sync="dialogFormVisible1" :before-close="handleClose" :modal="false">
      <el-form :model="form">
        ...
        <el-form-item  label="共同负责人"  class="s_client_item">
          <el-select v-model="partner" multiple clearable filterable placeholder="请选择" @change="changeClientInfo" style="width: 300px;" class="s_order_search">
            <el-option
                v-for="item in persons"
                :key="item.dd_id"
                :label="item.nickname"
        ...
        <el-form :inline="true" v-if="all_order">
          ...
          <div v-for="item in partner_sel" :key="item.dd_id" style="position: relative;top: -60px;left: 85px;">
            <el-form-item   :label="item.partner" class="s_client_item">
              <el-input v-model="item.percent"  autosize placeholder="两位整数" class="s_client_sel_div">
                <template slot="append">%</template>
              </el-input>
            </el-form-item>
          </div>
      ...
      <el-switch
          v-model="all_project"
          @change
          active-text="共同负责该客户下的所有项目">
      </el-switch>
      <el-switch
          v-model="all_order"
          @change
          active-text="共同负责该客户下的所有订单">
      </el-switch>
      <div slot="footer" class="dialog-footer">
